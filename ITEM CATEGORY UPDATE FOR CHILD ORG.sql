--------ITEM CATEGORY UPDATE FOR DR1 ORG------------
...
sELECT   B.INVENTORY_ITEM_ID,
  ...
  FROM   XXCM_ITEM_LOAD_STAGE_DR1 A,
         APPS.MTL_SYSTEM_ITEMS_B B,
         MTL_CATEGORIES C,
         MTL_ITEM_CATEGORIES D,
         MTL_CATEGORIES F
 WHERE   1 = 1 AND NVL (A.DR1_VALIDATE_FLAG, ' ') = 'Y'
...
--3.Run Item Category Assignment Open Interface Concurrent for a DR1 Org
   --I/P  3,Y,Y
